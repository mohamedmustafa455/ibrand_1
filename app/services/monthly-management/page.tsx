...
// Static page for the Monthly Management service
const service = servicesData.find(s => s.id === "monthly-management")
    ...
    <div dir={isRTL ? "rtl" : "ltr"} lang={isRTL ? "ar" : "en"} className={`min-h-screen overflow-x-hidden ${isDark ? "bg-slate-900" : "bg-gray-50"}`}>
      ...
      <section className={`py-20 ${isDark ? "bg-gradient-to-br from-slate-900 to-slate-800" : "bg-gradient-to-br from-blue-50/30 to-white"}`}>
        <div className="container mx-auto px-4">
          ...
          {/* Prefer continuous image slider (no cards), always autoplay */}
          <ServiceResultsGallery serviceId={service.id} display="carousel" showTags={false} showBadge={false} forceAutoPlay />
        </div>
      </section>
