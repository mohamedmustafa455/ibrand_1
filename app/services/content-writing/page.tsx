...
import ContentWritingPortfolio from "@/components/content-writing-portfolio"

// Static page for the Content Writing service
const service = servicesData.find(s => s.id === "content-writing")
