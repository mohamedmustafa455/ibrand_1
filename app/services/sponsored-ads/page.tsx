...
// Static page for the Sponsored Ads service
const service = servicesData.find(s => s.id === "sponsored-ads")
            ...
            <h2 className={`text-4xl md:text-5xl font-black mb-6 ${
              ...
              <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                {t("servicePage.gallery.title")}
                      ...
                      {/* Show as carousel with category filters */}
            <ServiceResultsGallery serviceId={service.id} display="carousel" showTags={true} showBadge={false} forceAutoPlay />
        </div>
      </section>
