...
// Static page for the Video Editing service
const service = servicesData.find(s => s.id === "video-editing")
    ...
    <div dir={isRTL ? "rtl" : "ltr"} lang={isRTL ? "ar" : "en"} className={`min-h-screen overflow-x-hidden ${isDark ? "bg-slate-900" : "bg-gray-50"}`}>
      ...
      <section className={`py-20 ${isDark ? "bg-gradient-to-br from-slate-900 to-slate-800" : "bg-gradient-to-br from-blue-50/30 to-white"}`}>
        <div className="container mx-auto px-4">
          ...
          {/* Custom video-first look: large video or slider; hide thumbs; pause autoplay during playback */}
          <ServiceResultsGallery serviceId={service.id} display="carousel" showTags={false} showBadge={false} forceAutoPlay hideThumbnails pauseOnVideoPlay />
        </div>
      </section>
